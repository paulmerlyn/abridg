...
<p class='text' style='margin-left: 150px; margin-right: 150px; margin-bottom: 60px;'>Click the button below to assign access to specific media for this account. Alternatively, click <a target='_self' href='/upload.php'>here</a> to upload media. Or click <a href='/index.php'>here</a> to visit the Media Gallery.</p>
</td>
<tr>
