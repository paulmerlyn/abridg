...
?>
	...
	<p class='text' style='margin-left: 150px; margin-right: 150px; margin-bottom: 60px;'>Click the button below to allow <?=$AssociateName; ?> to access specific media. Alternatively, click <a target='_self' href='/addassociate.php'>here</a> to add another friend. Or click <a href='/index.php'>here</a> to visit the Media Gallery.</p>
	</td>
	<tr>
