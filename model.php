...
<form id="chartmodelform" method="post" action="/model.php#chartanchor" style="margin-top: 40px;">
<table align="center">
...
if (isset($DrawChart))
	...
	if ($_SESSION['phpinvalidflag'])
		{
?>
		<script type='text/javascript' language='javascript'>window.location = '/model.php';</script>
		<noscript>
<?php
